...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The times 01.3.2018. Buxcoi project is here.";
        CTransaction txNew;
        txNew.nTime = 1520319998;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1520319998;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1520812983 : 377822;
       
                
        assert(block.hashMerkleRoot == uint256("0x5624a0719047a56274a31af7e4a82ce932179e4e6f4fbee30ce97d6a8a516dd2"));
